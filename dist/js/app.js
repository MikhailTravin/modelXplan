...
***************************************************************************** */
        ...
        function onChange() {
            ...
            if (file) {
                ...
                remove.addEventListener("click", (() => {
                    ...
                    setTimeout((() => {
                        item.remove();
                        if (!preview.querySelector(".preview")) preview.classList.remove("active");
                    }), 100);
                }));
    ...
    function toggleFilledClass(input) {
        if ("" !== input.value.trim()) input.classList.add("filled"); else input.classList.remove("filled");
    }
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        const updateTopStepsActive = bottomIndex => {
            if (topSteps[0]) topSteps[0].classList[bottomIndex >= 2 ? "add" : "remove"]("active");
            if (topSteps[1]) topSteps[1].classList[bottomIndex >= 4 ? "add" : "remove"]("active");
        };
        allSteps.forEach(((step, index) => {
            ...
            step.addEventListener("mouseleave", (() => {
                if (isVerticalLayout) lineFill.style.height = "0"; else lineFill.style.width = "0";
